    ...
    calculateXMindLayout() {
        ...
        const getSubtreeHeight = (node, depth) => {
            ...
            children.forEach((child, idx) => {
                ...
                if (idx < children.length - 1) {
                    ...
                    totalHeight += depth === 0 ? this.categorySpacing : this.siblingSpacing;
                }
            });
        ...
        const positionNode = (node, x, yStart, yEnd, depth, parentCategory) => {
            ...
            children.forEach((child, idx) => {
                ...
                // Use categorySpacing between top-level categories, siblingSpacing elsewhere
                currentY = childYEnd + (depth === 0 ? this.categorySpacing : this.siblingSpacing);
            });
        };
